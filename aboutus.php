<!DOCTYPE html>
  <html>
    <head>
	  ...
	  <?php include 'scripts/carouselscript.php';?>
  ...
  <div class="content">
    ...
    <div class="section">
      ...
      <img class="activator" src="background3.jpg">
      </div>
      <div class="card-content">
      <span class="card-title activator grey-text text-darken-4">Team Member Name<i class="material-icons right">more_vert</i></span>
      <p><a href="#">Profile Link</a></p>
      </div>
      <div class="card-reveal">
      <span class="card-title grey-text text-darken-4">Team Member Name<i class="material-icons right">close</i></span>
